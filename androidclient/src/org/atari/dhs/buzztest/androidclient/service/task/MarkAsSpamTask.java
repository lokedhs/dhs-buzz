...
public class MarkAsSpamTask implements ServiceTask
{
    public static final String COMMAND_NAME = "markAsSpam";
    ...
    public void processTask( TaskContext taskContext, BundleX args ) throws ServiceTaskFailedException {
        ...
        try {
            buzzManager.putEmptyBuzzActivity( BuzzGlobal.ROOT_URL + "activities/@me/@abuse/" + activityId );
        }
        catch( IOException e ) {
    ...
    public CharSequence getNotificationTickerText( Context context, BundleX args ) {
        return context.getResources().getString( R.string.task_mark_as_spam_ticker );
    }
